...
public class JedisUtil {
    ...
    /**
     * @Title:
     * getList @Description：(根据key以及类得到redis服务器中集合字符串对应的集合) @param @param
     * key @param @param clazz @param @return 设定文件 @return List<T> 返回类型 @throws
     */
    ...
    *//**
     *
     * @Title: isGoodJson @Description: (判断是否是json格式字符串) @param @param
     * json @param @return 设定文件 @return boolean 返回类型 @throws
     *//*
